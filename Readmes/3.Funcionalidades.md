...
- **Vista de detalle de transacción mejorada**

    Se ha rediseñado la pantalla de detalle con una estructura por tarjetas que prioriza el resumen del movimiento, impacto en cuenta, metadatos de control y visualización de adjuntos.

- **Tema visual global unificado**

    La interfaz se ha unificado con una paleta cian/teal para mantener consistencia visual entre dashboard, historial, modales y vistas de detalle.
---
### AVANZADAS
